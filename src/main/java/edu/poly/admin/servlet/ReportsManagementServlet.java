...
public class ReportsManagementServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		reportFavoritesUserByVideos(request, response);
	...
	protected void reportFavoritesByVideos(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			try {
				...
				List<FavoriteReport> list = dao.reportsByVideo();	
	...
	protected void reportFavoritesUserByVideos(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			FavoriteDao dao = new FavoriteDao();
			List<FavoriteUserReport> list = dao.reportFavoritesByVideo(videoUserId);
